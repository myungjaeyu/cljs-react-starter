...
/** @this {Function} */
cljs.tools.reader.impl.errors.throw_ex.cljs$lang$applyTo = (function (seq27544){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27545,G__27546,seq27544__$2);
});
...
var args__4736__auto__ = [];
var len__4730__auto___27607 = arguments.length;
var i__4731__auto___27608 = (0);
while(true){
if((i__4731__auto___27608 < len__4730__auto___27607)){
args__4736__auto__.push((arguments[i__4731__auto___27608]));

var G__27609 = (i__4731__auto___27608 + (1));
i__4731__auto___27608 = G__27609;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.impl.errors.reader_error.cljs$lang$applyTo = (function (seq27551){
var G__27552 = cljs.core.first(seq27551);
var seq27551__$1 = cljs.core.next(seq27551);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27552,seq27551__$1);
});
...
/** @this {Function} */
cljs.tools.reader.impl.errors.illegal_arg_error.cljs$lang$applyTo = (function (seq27553){
var G__27554 = cljs.core.first(seq27553);
var seq27553__$1 = cljs.core.next(seq27553);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27554,seq27553__$1);
});
...
/** @this {Function} */
cljs.tools.reader.impl.errors.eof_error.cljs$lang$applyTo = (function (seq27555){
...
var init = (function (){var G__27573 = kind;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__27573__$1)].join('')));
...
/** @this {Function} */
cljs.tools.reader.impl.errors.throw_eof_reading.cljs$lang$applyTo = (function (seq27570){
...
var iter__4523__auto__ = (function cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__27587(s__27588){
...
var c__4521__auto__ = cljs.core.chunk_first(s__27588__$2);
var size__4522__auto__ = cljs.core.count(c__4521__auto__);
var b__27590 = cljs.core.chunk_buffer(size__4522__auto__);
if((function (){var i__27589 = (0);
while(true){
if((i__27589 < size__4522__auto__)){
var vec__27591 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4521__auto__,i__27589);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27591,(0),null);
var freq = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27591,(1),null);
if((freq > (1))){
cljs.core.chunk_append(b__27590,id);

var G__27645 = (i__27589 + (1));
i__27589 = G__27645;
continue;
} else {
var G__27646 = (i__27589 + (1));
i__27589 = G__27646;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__27590),cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__27587(cljs.core.chunk_rest(s__27588__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__27590),null);
}
} else {
var vec__27594 = cljs.core.first(s__27588__$2);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27594,(0),null);
var freq = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27594,(1),null);
if((freq > (1))){
return cljs.core.cons(id,cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__27587(cljs.core.rest(s__27588__$2)));
} else {
var G__27650 = cljs.core.rest(s__27588__$2);
s__27588__$1 = G__27650;
continue;
}
}
} else {
