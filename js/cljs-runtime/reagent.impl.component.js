...
if((i < len)){
var k = (ks[i]);
var G__35985 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__35986 = (i + (1));
m = G__35985;
i = G__35986;
continue;
...
var temp__5737__auto__ = (p["argv"]);
if((temp__5737__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__35877 = (p["children"]);
return module$node_modules$react$index.Children.toArray(G__35877);
})());
} else {
var v = temp__5737__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__35879 = c;
var G__35879__$1 = (((G__35879 == null))?null:G__35879.prototype);
if((G__35879__$1 == null)){
return null;
} else {
return (G__35879__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__35883 = c;
var G__35883__$1 = (((G__35883 == null))?null:G__35883.prototype);
if((G__35883__$1 == null)){
return null;
} else {
return (G__35883__$1["render"]);
}
})() == null)))));
});
...
var G__35891 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__35891) : reagent.impl.component.as_element.call(null,G__35891));
};
...
var _STAR_current_component_STAR__orig_val__35892 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__35893 = c;
reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__35893;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__35892;
}});
...
return ((function (G__35894,G__35894__$1){
...
var c = this;
var G__35924_35996 = (c["cljsRatom"]);
if((G__35924_35996 == null)){
} else {
reagent.ratom.dispose_BANG_(G__35924_35996);
}
...
var renders_35998 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_35999 = cljs.core.first(cljs.core.vals(renders_35998));
if((cljs.core.count(renders_35998) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_35998))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_35999)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_35999], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__35956 = name;
switch (G__35956) {
case "":
...
var G__35962 = reagent.impl.component.cljsify(body);
return module$node_modules$create_react_class$index(G__35962);
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__35963 = fiber;
var G__35963__$1 = (((G__35963 == null))?null:(G__35963["type"]));
if((G__35963__$1 == null)){
return null;
} else {
return (G__35963__$1["displayName"]);
}
})();
var parent = (function (){var G__35964 = fiber;
if((G__35964 == null)){
return null;
} else {
return (G__35964["return"]);
}
})();
var path = (function (){var G__35967 = parent;
var G__35967__$1 = (((G__35967 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__35967) : reagent.impl.component.fiber_component_path.call(null,G__35967)));
if((G__35967__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__35967__$1)," > "].join('');
}
})();
...
var temp__5733__auto__ = (function (){var or__4131__auto__ = (function (){var G__35970 = c;
if((G__35970 == null)){
return null;
} else {
return (G__35970["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__35971._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4131__auto__ = (function (){var G__35973 = c;
if((G__35973 == null)){
return null;
} else {
return (G__35973["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var or__4131__auto____$1 = (function (){var G__35975 = c;
if((G__35975 == null)){
return null;
} else {
return G__35975._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4131__auto__ = (function (){var G__35977 = instance;
if((G__35977 == null)){
return null;
} else {
return (G__35977["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var G__35978 = instance;
if((G__35978 == null)){
return null;
} else {
return G__35978._currentElement;
}
}
})();
var name = (function (){var G__35979 = elem;
var G__35979__$1 = (((G__35979 == null))?null:(G__35979["type"]));
if((G__35979__$1 == null)){
return null;
} else {
return (G__35979__$1["displayName"]);
}
})();
var owner = (function (){var or__4131__auto__ = (function (){var G__35981 = elem;
if((G__35981 == null)){
return null;
} else {
return (G__35981["_owner"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
var path = (function (){var G__35983 = owner;
var G__35983__$1 = (((G__35983 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__35983) : reagent.impl.component.component_path.call(null,G__35983)));
if((G__35983__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__35983__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
