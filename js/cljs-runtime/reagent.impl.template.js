...
var G__35992 = o;
(G__35992[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__36029__delegate = function (args){
...
while (G__36030__i < G__36030__a.length) {G__36030__a[G__36030__i] = arguments[G__36030__i + 0]; ++G__36030__i;}
  args = new cljs.core.IndexedSeq(G__36030__a,0,null);
} 
return G__36029__delegate.call(this,args);};
G__36029.cljs$lang$maxFixedArity = 0;
G__36029.cljs$lang$applyTo = (function (arglist__36031){
var args = cljs.core.seq(arglist__36031);
return G__36029__delegate(args);
});
...
var G__35994 = o;
(G__35994[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__36032__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
return G__36032__delegate.call(this,args);};
...
return G__36032__delegate(args);
});
...
var G__35997 = props;
var G__35997__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__35997,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__35997);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__35997__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__36000){
...
var props = map__36001__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36001__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__36001,map__36001__$1,props,class$){
return (function (c){
...
});})(map__36001,map__36001__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__36004){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36005__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render(((function (node_value,map__36005,map__36005__$1,on_write){
return (function (){
...
});})(node_value,map__36005,map__36005__$1,on_write))
);
} else {
...
var G__36008 = jsprops;
(G__36008["defaultValue"] = value);

(G__36008["onChange"] = ((function (G__36008,v,value,on_change){
return (function (p1__36007_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__36007_SHARP_);
});})(G__36008,v,value,on_change))
);
...
var vec__36010 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36010,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36010,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36010,(2),null);
...
var jsprops = ({"argv": v});
var temp__5739__auto___36049 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___36049 == null)){
} else {
var key_36051 = temp__5739__auto___36049;
(jsprops["key"] = key_36051);
}
...
var temp__5739__auto___36052 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___36052 == null)){
} else {
var key_36053 = temp__5739__auto___36052;
reagent.impl.template.oset(jsprops,"key",key_36053);
}
...
var G__36014 = reagent.impl.template.__GT_NativeWrapper();
(G__36014["name"] = c);
...
var G__36015 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__36015) : reagent.impl.template.as_element.call(null,G__36015));
} else {
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq36018){
var G__36019 = cljs.core.first(seq36018);
var seq36018__$1 = cljs.core.next(seq36018);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__36019,seq36018__$1);
});
...
break;
default:
var G__36101 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__36101;
continue;
...
var n__4607__auto___36102 = a.length;
var i_36103 = (0);
while(true){
if((i_36103 < n__4607__auto___36102)){
(a[i_36103] = reagent.impl.template.as_element((a[i_36103])));

var G__36104 = (i_36103 + (1));
i_36103 = G__36104;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___36105 = a.length;
var i_36106 = (0);
while(true){
if((i_36106 < n__4607__auto___36105)){
var val_36107 = (a[i_36106]);
if(((cljs.core.vector_QMARK_(val_36107)) && ((reagent.impl.template.key_from_vec(val_36107) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_36106] = reagent.impl.template.as_element(val_36107));
...
var ctx = ({});
var vec__36022 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36022,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36022,(1),null);
...
var G__36025 = (cljs.core.count(argv) - first_child);
switch (G__36025) {
case (0):
...
case (1):
var G__36026 = comp;
var G__36027 = jsprops;
var G__36028 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return module$node_modules$react$index.createElement(G__36026,G__36027,G__36028);

break;
default:
return module$node_modules$react$index.createElement.apply(null,cljs.core.reduce_kv(((function (G__36025){
